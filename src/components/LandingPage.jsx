...
import { Sun, Moon,Star, ChevronRight, ArrowUp, MessageCircle, BookOpen, HelpCircle, Users } from "react-feather";
...
const LandingPage = () => {
  ...
  useEffect(() => {
    if (imagesLoaded && loadingBarRef.current) {
  ...
  return (
    ...
    >
      ...
      <LoadingBar
        ...
        onLoaderFinished={() => setLoadingProgress(100)}
      />
        ...
        <div className={`relative w-full h-80 rounded-2xl overflow-hidden shadow-xl ${darkMode ? "bg-gray-700" : "bg-blue-100"}`}>
          <img
            ...
            onError={(e) => {
              ...
              e.target.src = "https://via.placeholder.com/600x400?text=MindMate+App";
            }}
          />
          ...
          <div className="flex flex-col md:flex-row items-center">
            ...
            >
              ...
              <div className="flex flex-wrap gap-6">
                ...
                >
                  ...
                  <span className="font-medium text-lg">Meet Our Team</span>
                </motion.button>
              </div>
            </motion.div>
            ...
            >
              <Tilt
                ...
                className="h-full"
              >
                <div className={`rounded-2xl p-10 h-full bg-gradient-to-br ${
                  darkMode 
                  ...
                  <p className={`text-xl mb-8 ${
                    ...
                    To empower individuals to take control of their mental
                    health through accessible, evidence-based tools and
                    resources.
                  </p>
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className={`px-8 py-4 rounded-xl font-medium bg-gradient-to-r ${
                      darkMode 
                        ? "from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600" 
                        : "from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700"
                    } text-white shadow-lg text-lg transition-all`}
                    onClick={() => navigate("/signup")}
                  >
                    Join Our Forum
                  </motion.button>
